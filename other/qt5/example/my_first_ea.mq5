...
//--- input parameters
input int      StopLoss=30;      // Stop Loss, unit is pip, 1 pip is the rightmost even digit, pip ---- price movement, pip definition: https://www.babypips.com/learn/forex/pips-and-pipettes
input int      TakeProfit=100;   // Take Profit, unit is pip, 1 pip is the rightmost event digit, pip ---- price movement
...
//--- Get handle for ADX indicator
   adxHandle=iADX(NULL,0,ADX_Period); // Average Directional Movement Index indicator
...
//--- Let us handle currency pairs with 5 or 3 digit prices instead of 4
   // STP = StopLoss;
   // TKP = TakeProfit;
   STP = pips2points(StopLoss);
   TKP = pips2points(TakeProfit);
   /*
...
//--- Putting all together
  ...
  ulong pips2points(ulong x){if(Digits()%2==1){return(x*10);}else{return(x);} }
//+------------------------------------------------------------------+